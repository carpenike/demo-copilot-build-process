...
| [`projects/policy-chatbot/`](projects/policy-chatbot/) | Input only | **Clean starting point** — raw BRD input only, ready to run the full pipeline from scratch with all 8 skills in action |
